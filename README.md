...
Directly in a notebook: Using the InMemoryRunner to get quick, debug-style responses.

Via a web interface: Using the adk web command to spin up a local chat UI for interactive testing.
